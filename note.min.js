...
c=document.getElementsByTagName("body")[0],b=document.createTextNode(a.ok?"Noted.":"Error: "+a.error);d.style.cssText="position:fixed;height:32px;width:100%;text-align:center;top:0;left:0;padding:15px;z-index=2147483647;font-size:32px;color:#222;background-color:#f99";d.appendChild(b);c.appendChild(d);window.setTimeout(function(){b=null;c.removeChild(d)},a.ok?1E3:3E3);window._note_bookmarklet_user_id=null}};e.open("GET","//note.hp.af.cm/note/"+h+"?u="+bas64encode(unescape(encodeURIComponent(window.location.href)))+
